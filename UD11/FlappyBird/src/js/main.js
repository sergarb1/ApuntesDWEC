...
let game = new Phaser.Game(288, 505, Phaser.AUTO, '', { preload: preload, create: create, update: update });
...
function update() {
    ...
    if(!menu)
        pipes.forEach(function(pipeGroup) {game.physics.arcade.collide(bird, pipeGroup, deathHandler, null, this);}, this);
